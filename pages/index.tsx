    ...
    <div className="flex justify-center items-center h-screen">
      ...
      >
        ...
        <h2 className="font-serif text-sm leading-6 mt-4 text-gray-400">
          ...
          await you. From the soaring majesty of the Ninth Symphony by Beethoven
          to the breathtaking beauty of Nocturnes by Chopin, SymphonyNow invites
          you to immerse yourself in the sublime artistry of classical music. So
          come, let us journey together through the centuries, exploring the
          depths of human emotion and the limitless potential of the human
